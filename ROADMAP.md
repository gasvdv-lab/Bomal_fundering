...
- [x] v0.7.0 Full AR Raster Projection
- [x] v0.7.0.1 Raster Visibility Fix als één rigide ProjectRoot
...
- [x] v0.7.2.2 True WebXR Anchor World Lock: P00 via XRHitTestResult.createAnchor(), live anchor pose per frame.
